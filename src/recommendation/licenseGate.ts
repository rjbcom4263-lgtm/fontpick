...
export const COMMERCIAL_LICENSES: Record<string, CommercialLicenseRecord> = {
  ...
  'Gulim': {
    fontName: 'Gulim', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/gulim/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official Korean family under OFL; FontPick loads it only for web preview and generated output.',
  },
  'GulimChe': {
    fontName: 'GulimChe', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/gulimche/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official Korean family under OFL; the official TTF is used as a lazy web preview source.',
  },
  'DotumChe': {
    fontName: 'DotumChe', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/dotumche/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official Korean family under OFL; the official TTF is used as a lazy web preview source.',
  },
  'BatangChe': {
    fontName: 'BatangChe', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/batangche/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official Korean family under OFL; the official TTF is used as a lazy web preview source.',
  },
  'Gungsuh': {
    fontName: 'Gungsuh', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/gungsuh/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official Korean family under OFL; the official TTF is used as a lazy web preview source.',
  },
  'GungsuhChe': {
    fontName: 'GungsuhChe', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/gungsuhche/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official Korean family under OFL; the official TTF is used as a lazy web preview source.',
  },
  '42dot Sans': {
    fontName: '42dot Sans', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/42dotsans/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official variable Korean sans family; commercial use, web embedding and generated output are allowed under OFL.',
  },
  'Asta Sans': {
    fontName: 'Asta Sans', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/astasans/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official Korean family; commercial use, web embedding and generated graphics are allowed under OFL.',
  },
  'Moirai One': {
    fontName: 'Moirai One', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/google/fonts/blob/main/ofl/moiraione/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Google Fonts official Korean display family; commercial use, web embedding and generated graphics are allowed under OFL.',
  },
  'Pretendard': {
    fontName: 'Pretendard', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/orioncactus/pretendard/blob/main/LICENSE',
    verifiedAt: '2026-09-02',
    notes: 'Official project provides a versioned dynamic-subset webfont CDN and permits commercial use, modification and redistribution under OFL.',
  },
  'SUIT': {
    fontName: 'SUIT', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/sun-typeface/SUIT/blob/main/LICENSE',
    verifiedAt: '2026-09-02',
    notes: 'Official project provides WOFF2 webfonts and permits use, embedding, modification and redistribution under OFL.',
  },
  'Wanted Sans': {
    fontName: 'Wanted Sans', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/wanteddev/wanted-sans/blob/main/OFL.txt',
    verifiedAt: '2026-09-02',
    notes: 'Official project provides a versioned dynamic-subset webfont CDN and permits commercial use, modification and redistribution under OFL.',
  },
  'Spoqa Han Sans Neo': {
    fontName: 'Spoqa Han Sans Neo', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/spoqa/spoqa-han-sans/blob/main/LICENSE',
    verifiedAt: '2026-09-02',
    notes: 'Spoqa explicitly permits individual and business use, logos, embedding, modification and redistribution under OFL.',
  },
  'Maru Buri': {
    fontName: 'Maru Buri', status: 'APPROVED', licenseType: 'NAVER Open Font License',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'not-offered',
    officialLicenseUrl: 'https://hangeul.naver.com/maruproject_11',
    verifiedAt: '2026-09-02',
    notes: 'NAVER identifies Maru Buri as an open-license font free for commercial use. FontPick links a webfont preview and does not offer font-file downloads.',
  },
  'Nanum Square': {
    fontName: 'Nanum Square', status: 'APPROVED', licenseType: 'NAVER Open Font License',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'not-offered',
    officialLicenseUrl: 'https://campaign.naver.com/nanumsquare_neo/',
    verifiedAt: '2026-09-02',
    notes: 'NAVER permits personal and business commercial use and provides webfont formats. FontPick does not offer font-file downloads.',
  },
  'Gmarket Sans': {
    fontName: 'Gmarket Sans', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'not-offered',
    officialLicenseUrl: 'https://corp.gmarket.com/fonts/',
    verifiedAt: '2026-09-02',
    notes: 'Gmarket officially states that individuals and businesses may use the family freely for commercial and non-commercial purposes under OFL.',
  },
  'D2Coding': {
    fontName: 'D2Coding', status: 'APPROVED', licenseType: 'SIL OFL 1.1',
    commercialUse: true, webUse: true, generatedOutputUse: true,
    fontFileRedistribution: 'allowed-with-license',
    officialLicenseUrl: 'https://github.com/naver/d2-coding-font/blob/master/OFL.txt',
    verifiedAt: '2026-09-02',
